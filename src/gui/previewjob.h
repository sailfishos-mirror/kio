...
public:
     ...
     *
     * \sa gotPreview(), finished()
     * \since 6.15
     */
    bool useImage() const;

    /*!
     * Sets whether the PreviewJob produces previews as QImage objects.
     *
     * \since 6.15
     */
...
Q_SIGNALS:
    ...
    /*!
     * Emitted when a \a preview for \a item has been successfully retrieved.
     *
